...
public class PantallaPagoRealizado extends AppCompatActivity {
    ...
    /**
     * Configura el RecyclerView del filtro
     */
    ...
    /**
     * ⏱️ Espera 3 segundos y vuelve automáticamente al catálogo
     */
    private void iniciarRedireccionAutomatica() {
